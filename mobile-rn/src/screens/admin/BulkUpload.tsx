...
export default function BulkUpload() {
  ...
  if (isLoading) {
    return (
      <View style={styles.centered}>
        <AdminImportLoading title="Preparing delivery import" />
      </View>
    );
  }
  ...
  if (!editableDeliveries) {
    return (
      <AdminImportLanding
        ...
        description="Upload a CSV, resolve any row issues, then import the valid delivery records."
        requirements={[
          'Required columns: customerName, customerAddress, invoiceNumber, and scheduledDate.',
          'Use YYYY-MM-DD dates, for example 2025-10-17.',
          'Optional columns include customer phone, driver email, notes, and items.',
        ]}
        note="Each delivery can include up to 10 line items."
  ...
  return (
    <View style={styles.container}>
      <AdminImportReviewSummary
        fileName={fileName ?? 'Delivery CSV'}
        ...
        <View style={styles.modalBackdrop}>
          <ScrollView style={[styles.modalCard, shadows.card]}>
            ...
            <Text style={styles.helpLine}>
              4. Review and edit data in the table
            </Text>
