    ...
    return PopupMenuButton<VoidCallback>(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, size: 17, color: Colors.white.withValues(alpha: 0.95)),
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.dashboard, color: Color(0xFF6B7A89)),
            ...
            const Divider(),
            ListTile(
              leading: const Icon(Icons.map, color: Color(0xFF7A8A9A)),
            ...
            ListTile(
              leading: const Icon(Icons.settings, color: Color(0xFF6B7A89)),
            ...
            ListTile(
              leading: const Icon(Icons.help_outline, color: Color(0xFF7A9A8A)),
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            leading: const Icon(Icons.book, color: Color(0xFF7A8A9A)),
                          ...
                          const Divider(),
                          ListTile(
                            leading: const Icon(Icons.lightbulb, color: Color(0xFF9A8A7A)),
                          ...
                          const Divider(),
                          ListTile(
                            leading: const Icon(Icons.contact_support, color: Color(0xFF8A7A99)),
            ...
            const Divider(),
            ListTile(
              leading: const Icon(Icons.close, color: Color(0xFF8F9BA8)),
